...
//        params.setUDID(System.getProperty("udid", "2BDA5531-67F8-4FAB-B683-C2F269BFE39F"));
//        params.setDeviceName(System.getProperty("deviceName", "IPhone 8"));

        switch(params.getPlatformName()){
            case "Android":
                params.setSystemPort(System.getProperty("systemPort", "10005"));
                params.setChromeDriverPort(System.getProperty("chromeDriverPort", "11005"));
                break;
            case "iOS":
