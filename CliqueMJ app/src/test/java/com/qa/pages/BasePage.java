...
//        scrollObject.put("toVisible", "sdfnjksdnfkld");
    ...
    public void enterInKeyboard(String s){
        Actions action=new Actions(driver);
        action.sendKeys(s).sendKeys(Keys.ENTER).build().perform();//Here i am getting an exception saying it is not yet implemented.
